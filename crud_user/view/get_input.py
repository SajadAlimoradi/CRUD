...
# def view():
#     """View function for interacting with the CRUD Control."""
#     banner()
#     print(colored(start_message.renderText('Welcome to CRUDE v0.1.0 '), 'green'))
#     time.sleep(3)
#     while True:
#         clear_screen()
...
#         data_input.create_user()
#         data_input.read_user()
#         data_input.update_user()
#         data_input.delete_user()
#         data_input.help_user()
